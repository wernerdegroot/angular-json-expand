...
module converters {
    ...
    // Converts between an id (of type ID_TYPE) and a subject with this id (which should extend
    // IdSubject<ID_TYPE>). It uses a Repository (with a corresponding ResourceLocation) to do so. 
